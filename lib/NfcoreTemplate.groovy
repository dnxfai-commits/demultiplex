...
class NfcoreTemplate {
    ...
    public static String logo(workflow, monochrome_logs) {
        ...
        String.format(
            ...
            ${colors.green}  _   _ ______ _____ ______ _____ _____                  ${colors.reset}   
            ${colors.green} | \\ | |  ____/ ____|  ____|  __ \\_   _|   /\\         ${colors.reset}
            ${colors.green} |  \\| | |__ | |  __| |__  | |  | || |    /  \\         ${colors.reset}
            ${colors.green} | . ` |  __|| | |_ |  __| | |  | || |   / /\\ \\        ${colors.reset}
            ${colors.green} | |\\  | |___| |__| | |____| |__| || |_ / ____ \\       ${colors.reset}
            ${colors.green} |_| \\_|______\\_____|______|_____/_____/_/    \\_\\    ${colors.reset}
